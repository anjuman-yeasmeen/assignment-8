    ...
    <div className="navbar bg-base-100 shadow-sm px-4 md:px-10 sticky top-0 z-50">
      ...
      <div className="navbar-start">
        ...
        <Link href="/" className="flex items-center gap-2">
          <span className="text-xl font-bold tracking-tighter text-orange-600 hidden sm:block">
            HEATWAVE
          </span>
        </Link>
      </div>
        ...
        {user ? (
          <div className="dropdown dropdown-end">
            <div
              tabIndex={0}
              role="button"
              className="btn btn-ghost btn-circle avatar border-2 border-orange-400"
            >
          ...
          <div className="flex gap-2">
            ...
            <Link
              href="/register"
              className="btn bg-orange-500 hover:bg-orange-600 text-white btn-sm md:btn-md border-none"
            >
              Register
            </Link>
          </div>
